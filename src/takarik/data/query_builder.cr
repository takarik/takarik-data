module Takarik::Data
  class QueryBuilder(T)
    ...
    # Private helper method to quote column names consistently
    ...
    # Private helper method to get combined parameters in correct order
    ...
    # Private helper method for join operations
